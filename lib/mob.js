...
function init(game, _atlas) {
  atlas = _atlas
  game.entities.names.mobAI = game.entities.createComponent(
      require('../components/mobAI')(game))
  initted = true
}
...
function createMob( game, atlas, w, h, x, y, z ) {
  ...
  game.entities.addComponent(id, game.entities.names.collideEntities, {
  ...
  game.entities.addComponent(id, game.entities.names.mobAI, {
    stand_frame: stand_frame,
    jump_frame: jump_frame,
  })
  game.entities.addComponent(id, game.entities.names.sprite, {
    atlas: atlas
  })
}
